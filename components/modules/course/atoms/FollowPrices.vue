<template>
  <div class="follow-prices">
    <div
      v-if="price || priceRecurrent"
      class="follow-prices__price"
    >
      {{ priceRecurrent
    ...
    <div
      ...
      class="follow-prices__additional"
    >
      <div
        v-if="priceRecurrent && price"
        class="follow-prices__currency"
      >
        {{ money(price) }} {{ getCurrency(currency) }}
      </div>
      <div
        v-if="priceOld"
        class="follow-prices__old"
      >
...
@import "@/assets/scss/components/modules/course/atoms/followPrices";
</style>
